...
import (
	...
	//"github.com/crossplane/oam-controllers"
...
func (r *ServiceTraitReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	var service corev1alpha1.ServiceTrait
...
func (r *ServiceTraitReconciler) createService(ctx context.Context, service corev1alpha1.ServiceTrait,
